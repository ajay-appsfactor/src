import ServiceTable from "@/components/superadmin/master-list/vendor-certifications-table/ServiceTable";
  ...
  return (
    <section className="w-full max-w-8xl mx-auto">
      <div className="flex items-center justify-start gap-4 px-6 py-4">
        ...
        >
          <Link href="/super-admin/master-list/vendor-certifications/create">
