  ...
  return (
    <>
      ...
      <div className="bg-white border border-gray-200 rounded w-full p-6">
        ...
        <hr className="mb-8" />
        {/* Send offers */}
        <div className="flex items-center sm:justify-start md:justify-end mb-6 overflow-x-auto">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-4 border-x  rounded divide-y md:divide-y-0 md:divide-x">
          {/* Customer */}
        ...
        <div className="border-x border-t rounded grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x">
          {/* Internal Notes */}
